...
# ==== LINE Bot 設定 ====
LINE_CHANNEL_ACCESS_TOKEN = "jhqh1eqTNFzl6uM30HXt14IrYgRX+wZ6bxT5Uf/snr/dWl8KkQ2jmPvzdFlFcrVVUcbsVnbzAK9IdbbfeQkJcEHXbH6mDh3pZLDHaWimIAbgjVKyqzFRYH+FpjdsuYsj/FNwpBdOCn55wkrwP9ajTwdB04t89/1O/w1cDnyilFU="
LINE_CHANNEL_SECRET = "70a36a332d4d50977982441825bbabc6"
...
def handle_user_message(user_input):
   ...
   if user_input == "明日菜價":
     ...
     for veg, avg, price in selected:
      ...
      return result = "請輸入正確指令：明日菜價、建議食譜"
   else:
      return result
# ==== Flask Webhook ====
